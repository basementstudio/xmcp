...
<Callout variant="info" icon="gamepad-2" title="Arcade App Example">
  In this guide, we'll use the arcade app as an example project.
  You can find the complete source on <a href="https://github.com/xmcp-dev/arcade" target="_blank" rel="noopener noreferrer">GitHub</a> and a build guide <a href="/blog/doom-with-xmcp">here</a>.
</Callout>

...
It's been a busy few months. We've shipped GPT app integrations, React components, connections to external MCPs, and even monetization support. Here's a recap of everything we've built.

## GPT Apps

xmcp is fully integrated with OpenAI Apps SDK, so you can build and run apps directly inside ChatGPT. Tools can return React components for interactive, composable widgets.
...
Tools can return React components for interactive, composable widgets. xmcp renders the component to HTML and generates a widget resource automatically.
...
{/* TODO: Add content for Next.js Adapter */}

## Authentication

{/* TODO: Add content for Authentication */}
...
- **Rspack migration**: xmcp was initially built with Webpack, but with v0.5.0 we replaced it with Rspack for a major performance overhaul. Build times dropped significantly, and bundle sizes decreased by a third.

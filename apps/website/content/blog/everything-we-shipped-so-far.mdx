...
Connect to external MCP servers over HTTP or STDIO, then turn their tools into building blocks for yours. Define clients in `src/clients.ts`:
...
For adding HTTP clients, this is the type you have to follow:
...
For adding STDIO clients, the npm package must be installed in your project. This is the type you have to follow:
...
Afterwards, import them in your tools:
...
For the full setup, including authentication, check out the [Next.js adapter](/docs/adapters/nextjs) documentation.
...
<video
  ...
  style={{ borderRadius: "8px", marginTop: "1rem", marginBottom: "1rem" }}
>
  <source src="/blog/apps-monetization.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>

For the full guide, check out the [Monetize your GPT apps with Stripe](/blog/apps-monetization) blog post.

### Tools suscription based access or usage tracking

Use Polar to paywall your tools or track usage:
...
Share your feedback and help shape the future of xmcp [GitHub](https://github.com/basementstudio/xmcp). If you have any questions, you can reach out to us on [Discord](https://discord.gg/d9a7JBBxV9).
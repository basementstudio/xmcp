...
Since our launch on xmcp now lets you build GPT apps, render React widgets, connect to external MCPs, monetize and authenticate your tools.
...
For the full setup guide, check out the [OpenAI Apps SDK integration](/docs/) blog post.

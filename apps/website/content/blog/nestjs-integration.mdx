...
This is the one integration step init can't do for you — it prints these exact instructions when it finishes. Import `XmcpModule` into your application module:

...
To understand how the metadata works, you can read the [Apps SDK documentation](/docs/integrations/openai).
...
You can find the complete framework guide in the [xmcp Documentation](https://xmcp.dev/docs), explore the Apps SDK features with the [Apps SDK Guide](/blog/apps-sdk), browse source code and examples on the [GitHub Repository](https://github.com/basementstudio/xmcp), or join the [Discord Community](https://discord.gg/d9a7JBBxV9) to get help and share your projects.

[Contributing](https://xmcp.dev/blog/v0.3.0-release#contributing)

...
## Add your clients
You need to create the `clients.ts` in the `/src` directory and then add the MCP servers. HTTP entries can forward headers; STDIO entries spawn npm packages. You can type your clients out by using `ClientConnections`.
...
You need to have the npm package installed in your app if you wanna use STDIO.
</Callout>

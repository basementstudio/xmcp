...
description: "An MCP server with x402 payment middleware for USDC micropayments"
category: "monetization"
tags: ["x402", "payments", "http"]
---
...
export default paid({ price: 0.05 }, async function hashString({ input }) {

...
Public tools are accessible by any authenticated user without requiring specific permissions. To make tools public, add them to the `publicTools` array in your middleware configuration:

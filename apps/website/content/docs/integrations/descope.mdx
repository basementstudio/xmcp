...
If you don't already have one, create a project at [app.descope.com](https://app.descope.com). Copy the **Project ID** from the project settings — it follows the format `Pxxxxxxxxxxxxxxxxxxxxxxxxx`.
...
```bash
# Descope credentials
DESCOPE_PROJECT_ID=Pxxxxxxxxxxxxxxxxxxxxxxxxx

...
summary: "Build interactive interfaces for your MCP server with MCP UI."
description: "Create server-side UI resources with raw HTML, external URLs, and Remote DOM scripts, using text or blob encoding for seamless client rendering"
---

...
When no icons are configured, xmcp will look for a `favicon.ico` in your project. If found, it will be used as the default icon. Otherwise, the xmcp logo is used.

  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* Top actions bar */}
        <div className="flex items-center justify-between p-4 border-b border-brand-neutral-400 bg-brand-black">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div
          className={cn(hasMessages ? "border-t border-brand-neutral-400" : "")}
        >

...
export const buttonVariants = cva(
  "inline-flex items-center justify-center p-2 text-sm font-medium transition-colors duration-200 disabled:pointer-events-none focus-visible:outline-none rounded-xs",
  {
    variants: {
      variant: variants,

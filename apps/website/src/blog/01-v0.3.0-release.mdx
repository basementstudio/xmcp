...
When we first started xmcp, our main focus was on tools. As many clients adopted the MCP protocol, we felt it was time to extend the framework to be 100% compliant.

...
import { DEFAULT_CORS_CONFIG } from "@/runtime/transports/http/cors/defaults";
...
const corsConfigBaseSchema = z.object({
  origin: z
    ...
    .default(DEFAULT_CORS_CONFIG.origin),
  methods: z
    .union([z.string(), z.array(z.string())])
    .default([...DEFAULT_CORS_CONFIG.methods]),
  allowedHeaders: z
    .union([z.string(), z.array(z.string())])
    .default([...DEFAULT_CORS_CONFIG.allowedHeaders]),
  exposedHeaders: z
    .union([z.string(), z.array(z.string())])
    .default([...DEFAULT_CORS_CONFIG.exposedHeaders]),
  credentials: z.boolean().default(DEFAULT_CORS_CONFIG.credentials),
  maxAge: z.number().default(DEFAULT_CORS_CONFIG.maxAge),
});
